...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    final _firstname = context
        .select((UserProvider user) => user.firstname);
    final _lastname = context
        .select((UserProvider user) => user.lastname);
    final _gender = context
        .select((UserProvider user) => user.gender);
    final _age = context
        .select((UserProvider user) => user.age);
